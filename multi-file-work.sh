...
curl -i -X PATCH -H "Content-Type: application/sparql-update" --data-binary @pcdm-content1.ru       ${BASE}/gf1/files/content/fcr:metadata
curl -i -X PUT -H   "Content-Type: image/png"                 --data-binary @file1/thumbnail.png    ${BASE}/gf1/files/thumbnail
curl -i -X PATCH -H "Content-Type: application/sparql-update" --data-binary @pcdm-thumbnail1.ru     ${BASE}/gf1/files/thumbnail/fcr:metadata
curl -i -X PUT -H   "Content-Type: text/xml"                  --data-binary @file1/fits.xml         ${BASE}/gf1/files/characterization
curl -i -X PATCH -H "Content-Type: application/sparql-update" --data-binary @pcdm-fits1.ru          ${BASE}/gf1/files/characterization/fcr:metadata
...
curl -i -X PATCH -H "Content-Type: application/sparql-update" --data-binary @pcdm-fits2.ru          ${BASE}/gf2/files/characterization/fcr:metadata
